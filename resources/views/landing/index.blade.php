<x-layouts.app>
    ...
    <!-- Hero Section -->
    <section class="relative overflow-hidden min-h-[calc(100dvh-5rem)] flex items-center bg-semudah-bg dark:bg-slate-900 font-sans" id="home">
        <!-- Background Decorations -->
        <div class="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
            <div class="absolute top-[-10%] right-[-5%] w-96 h-96 bg-semudah-accent/10 dark:bg-semudah-accent/5 rounded-full"></div>
            <div class="absolute bottom-[-10%] left-[-10%] w-[30rem] h-[30rem] bg-semudah-secondary/10 dark:bg-semudah-secondary/5 rounded-full"></div>
        </div>
        ...
        <div class="w-full mx-auto px-6 lg:px-12 xl:px-20 py-12 md:py-20">
            ...
            <div class="space-y-6 md:space-y-8 flex flex-col items-center lg:items-start text-center lg:text-left">
                <div class="inline-flex px-4 py-1.5 bg-semudah-accent/10 dark:bg-slate-800 rounded-full text-semudah-primary dark:text-semudah-accent text-sm font-semibold tracking-wide items-center justify-center lg:justify-start w-fit gap-1.5 border border-semudah-secondary/20 dark:border-slate-700 transition-colors">
                    <x-heroicon-s-sparkles class="w-4 h-4" /> Welcome to SEMUDAH
                </div>
                
                <h1 class="font-heading text-4xl md:text-5xl lg:text-6xl font-extrabold leading-[1.2] tracking-tight text-slate-900 dark:text-white transition-colors">
                    <span class="text-semudah-primary dark:text-semudah-secondary">Semua Menjadi</span>
                    <br>
                    <span>Mudah</span>
                </h1>
                
                <p class="text-slate-600 dark:text-slate-400 text-lg lg:text-xl leading-relaxed max-w-lg lg:max-w-2xl mx-auto lg:mx-0">
                ...
                <div class="flex flex-col sm:flex-row flex-wrap gap-4 pt-2 justify-center lg:justify-start w-full sm:w-auto">
                    <a href="{{ route('landing.catalog') }}" class="bg-semudah-primary hover:bg-semudah-primary/90 dark:bg-semudah-secondary dark:hover:bg-semudah-secondary/90 text-white px-8 py-4 lg:px-10 lg:py-5 lg:text-lg rounded-[8px] font-semibold transition-all shadow-[0_4px_12px_rgba(30,100,138,0.15)] hover:shadow-[0_8px_20px_rgba(30,100,138,0.2)] hover:-translate-y-1 text-center w-full sm:w-auto" id="btn-hero-catalog">
                        Lihat Katalog
                    </a>
                    <a href="#keunggulan" class="bg-transparent border-[1.5px] border-semudah-secondary text-semudah-primary dark:text-semudah-accent hover:bg-semudah-bg dark:hover:bg-slate-800 px-8 py-4 lg:px-10 lg:py-5 lg:text-lg rounded-[8px] font-semibold transition-all text-center w-full sm:w-auto hover:-translate-y-1" id="btn-hero-features">
                        Tentang Kami
                    </a>
                </div>
                
                <!-- Stats -->
                <div class="grid grid-cols-3 gap-6 md:gap-10 mt-10 p-6 md:p-8 rounded-[12px] bg-white dark:bg-slate-800 border border-semudah-primary/10 dark:border-slate-700 shadow-sm w-full transition-colors relative overflow-hidden">
                    <div class="flex flex-col items-center lg:items-start text-center lg:text-left relative z-10">
                        <h2 class="font-heading text-3xl md:text-4xl lg:text-5xl font-extrabold text-semudah-primary dark:text-semudah-accent">500+</h2>
                    ...
                    <div class="flex flex-col items-center lg:items-start text-center lg:text-left relative z-10">
                        <h2 class="font-heading text-3xl md:text-4xl lg:text-5xl font-extrabold text-semudah-primary dark:text-semudah-accent">10+</h2>
                    ...
                    <div class="flex flex-col items-center lg:items-start text-center lg:text-left relative z-10">
                        <h2 class="font-heading text-3xl md:text-4xl lg:text-5xl font-extrabold text-semudah-primary dark:text-semudah-accent">100%</h2>
    ...
    <!-- Keunggulan Section -->
    <section class="py-20 md:py-24 bg-semudah-bg dark:bg-slate-900 border-y border-gray-100 dark:border-slate-800 font-sans" id="keunggulan">
        <div class="w-full mx-auto px-6 lg:px-12 xl:px-20">
            
            <div class="text-center max-w-2xl mx-auto space-y-3">
                <div class="inline-flex items-center gap-1.5 px-4 py-1.5 bg-semudah-accent/10 dark:bg-slate-800 rounded-full text-semudah-primary dark:text-semudah-accent text-xs font-semibold tracking-wide border border-semudah-secondary/20 dark:border-slate-700">Mengapa Memilih Kami</div>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mt-16">
                ...
                <!-- Card 1 -->
                <div class="bg-white dark:bg-slate-800 p-8 rounded-[12px] shadow-[0_4px_12px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] dark:shadow-slate-900/50 border border-semudah-primary/10 dark:border-slate-700 hover:border-semudah-secondary dark:hover:border-semudah-accent hover:-translate-y-1 transition-all duration-300 group">
                    <div class="w-14 h-14 rounded-[8px] bg-semudah-secondary/10 dark:bg-slate-700 flex items-center justify-center text-semudah-primary dark:text-semudah-accent group-hover:bg-semudah-primary group-hover:text-white dark:group-hover:bg-semudah-secondary dark:group-hover:text-slate-900 transition-all duration-300 shadow-sm">
                        <svg class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                        </svg>
                    </div>
                    <h3 class="font-heading font-bold text-xl text-slate-800 dark:text-gray-100 mt-6 group-hover:text-semudah-primary dark:group-hover:text-semudah-accent transition-colors">Proses Cepat</h3>
                ...
                <div class="bg-white dark:bg-slate-800 p-8 rounded-[12px] shadow-[0_4px_12px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] dark:shadow-slate-900/50 border border-semudah-primary/10 dark:border-slate-700 hover:border-semudah-secondary dark:hover:border-semudah-accent hover:-translate-y-1 transition-all duration-300 group">
                    ...
                    <h3 class="font-heading font-bold text-xl text-slate-800 dark:text-gray-100 mt-6 group-hover:text-semudah-primary dark:group-hover:text-semudah-accent transition-colors">Sangat Berkualitas</h3>
                ...
                <div class="bg-white dark:bg-slate-800 p-8 rounded-[12px] shadow-[0_4px_12px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] dark:shadow-slate-900/50 border border-semudah-primary/10 dark:border-slate-700 hover:border-semudah-secondary dark:hover:border-semudah-accent hover:-translate-y-1 transition-all duration-300 group">
                    ...
                    <h3 class="font-heading font-bold text-xl text-slate-800 dark:text-gray-100 mt-6 group-hover:text-semudah-primary dark:group-hover:text-semudah-accent transition-colors">Harga Terjangkau</h3>
                    <p class="text-slate-500 dark:text-slate-400 text-sm mt-3 leading-relaxed">Memberikan harga bersahabat terutama untuk pelajar dan mahasiswa.</p>
                </div>
                ...
                <div class="bg-white dark:bg-slate-800 p-8 rounded-[12px] shadow-[0_4px_12px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] dark:shadow-slate-900/50 border border-semudah-primary/10 dark:border-slate-700 hover:border-semudah-secondary dark:hover:border-semudah-accent hover:-translate-y-1 transition-all duration-300 group">
                    ...
                    <h3 class="font-heading font-bold text-xl text-slate-800 dark:text-gray-100 mt-6 group-hover:text-semudah-primary dark:group-hover:text-semudah-accent transition-colors">Beragam Layanan</h3>
                    <p class="text-slate-500 dark:text-slate-400 text-sm mt-3 leading-relaxed">Mulai dari dokumen hingga merchandise custom, kami siap melayani.</p>
                </div>
