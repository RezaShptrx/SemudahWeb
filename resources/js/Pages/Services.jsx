        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-slate-500 text-sm mt-1">Manage main service lines</p>
                </div>
                <button 
                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-slate-700">
                            {services.map(srv => (
                                <tr key={srv.id} className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                                    <td className="px-6 py-4 font-medium text-slate-900 dark:text-white">{srv.name}</td>
                                    <td className="px-6 py-4"><span className="px-2.5 py-1 bg-slate-100 dark:bg-slate-700 rounded-lg text-xs">{srv.slug}</span></td>
