...
class TshirtOrderForm extends Component
{
    public $product;
    public $selectedSize = 'L';
    public $selectedColor = 'Hitam';
    public $selectedMaterial = 'Cotton Combed 30s';
    public $quantity = 1;
    public $notes = '';
    ...
    public function proceedToCheckout()
    {
        $this->validate([
            ...
            'uploadedFiles.required' => 'Silakan unggah desain/gambar yang akan disablon di kaos.',
            'uploadedFiles.min' => 'Silakan unggah desain/gambar yang akan disablon di kaos.',
        ]);
    ...
    {
        return view('livewire.forms.tshirt-order-form');
    }
}
